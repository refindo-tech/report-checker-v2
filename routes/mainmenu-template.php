...
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('dev')->group(function () {
    // DEVELOPER
...
// INTEL
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('intel')->group(function () {
...
// SETTING
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('setting')->group(function () {
...
// DOC
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('docs')->group(function () {
...
// UI
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('ui')->group(function () {
...
// utilities
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('utilities')->group(function () {
...
// font icon
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('icons')->group(function () {
...
//tabel
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('tables')->group(function () {
...
//Form Stuff
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('form_stuff')->group(function () {
...
//Plugins
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('plugins')->group(function () {
...
//datatables
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('datatables')->group(function () {
...
// statistics
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('statistics')->group(function () {
...
//notifikasi
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('notifications')->group(function () {
...
//form plugins
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('form_plugins')->group(function () {
...
//Miscellaneous
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('miscellaneous')->group(function () {
...
// Forum
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('pages/forum')->group(function () {
...
//pages inbox
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('pages/inbox')->group(function () {
...
//Authentication
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('pages/authentication')->group(function () {
...
//Error Pages
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('pages/error')->group(function () {
...
Route::middleware(['auth', 'role:Super Admin', 'verified'])->prefix('pages/other')->group(function () {
