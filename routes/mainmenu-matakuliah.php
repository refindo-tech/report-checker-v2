...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('permission:lihat-matakuliah')->prefix('matakuliah')->group(function () {
        Route::get('/index', [MataKuliahController::class, 'index'])->name('matakuliah.index');
    });
    });
    // Rute untuk menambah barang masuk (Admin, Gudang)
    Route::middleware('permission:tambah-matakuliah')->prefix('matakuliah')->group(function () {
    ...
    Route::middleware('permission:edit-matakuliah')->prefix('matakuliah')->group(function () {
    ...
    Route::middleware('permission:hapus-matakuliah')->prefix('matakuliah')->group(function () {
